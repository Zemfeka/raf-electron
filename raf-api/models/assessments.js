...
var Assessments = {
        ...
        addAssessments: function(assessment, callback) {
            return db.query("INSERT INTO `test`.`assessments`(`Notes`,`UserId`,BookingId,`ShowNoShow`) VALUES (?,?,?,?)", [assessment.Notes, assessment.UserId, assessment.BookingId, assessment.ShowNoShow], callback);
        },
