...
var LoginComponent = (function () {
    function LoginComponent(router, _electronService, http) {
        this.router = router;
        this._electronService = _electronService;
        this.http = http;
        //private _postsURL = "http://localhost:3000/users/profile?id=1";
        this._postsURL = "http://localhost:3000/users/authenticate";
    ...
    LoginComponent.prototype.onLoggedin = function () {
        ...
        var authenticated = this.Auth()
            .subscribe(function (resultArray) { return _this._postsArray = resultArray; }, function (error) { return console.log("Error :: " + error); });
        console.log(this.arr);
        localStorage.setItem('isLoggedin', 'true');
    };
    LoginComponent.prototype.handleError = function (error) {
        return __WEBPACK_IMPORTED_MODULE_5_rxjs_Observable__["a" /* Observable */].throw(error.statusText);
    };
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_3_ngx_electron__["a" /* ElectronService */], __WEBPACK_IMPORTED_MODULE_4__angular_http__["b" /* Http */]])
    ], LoginComponent);
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "timeInterval", function() { return __WEBPACK_IMPORTED_MODULE_87__timeInterval__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "timestamp", function() { return __WEBPACK_IMPORTED_MODULE_90__timestamp__["a"]; });
